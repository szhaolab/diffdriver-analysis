...
In total, **920 analyses** were conducted successfully across **20 tumor types**, involving **46 distinct phenotypes**:
...
- Prostate_cancer_2017_common

- ukbEUR_IRON_DEFICIENCY

- RA_NG2010.hap3

- ukbEUR_IRRITABLE_BOWEL
...
- ukbEUR_SEVERE_OBESITY

- Vitiligo

- ukbEUR_TI_cojo

- ukbEUR_ALLERGIC_RHINITIS

- ukbEUR_VARICOSE_VEINS

All 920 analyses were successfully completed without any errors.
...
filedf <- get_files(
  outputdir = "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/temp/output/PRS"
)
...
```{r}
pheno_path <- "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/batch5/tumor_specific_input/HNSC/HNSC_PRS_46phenotype.txt"
