...
```{r}
mut_path <- "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/tumor_specific_input/BLCA/BLCA_mutations.txt"
mut <- read.table(mut_path, header = TRUE, sep = "\t")
head(mut)
```

```{r}
pheno_path <- "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/batch2/tumor_specific_input/BLCA/BLCA_C2.txt"
...
df_single <- subset(df_summary, pheno == "C4")
plot_one_pheno(
  df_single  = df_single, 
  pheno_name = "C4" 
)
