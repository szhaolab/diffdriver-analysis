...
Per-sample signature proportions (fastTopics structure plot), grouped by tumor
type then smoking status; within each group samples keep the fastTopics
loadings-similarity ordering; tracks above show the sample-level labels. 
