---
title: "Uterine cancer subtype analysis"
author: "Qirui Zhang"
date: "2025-12-29"
output: 
  html_document:
...
### 1.A.2 YaleSerous_vs_YaleUCS_newGene
Phenotype: a phenotype file for Yale serous and Yale UCS. Pull samples from both categories, if the sample is Yale serous, then give the phenotype value 1, otherwise give 0.  
Gene: /dartfs/rc/lab/S/Szhao/diffDriver/diffDriver/data_run_UCS/Yale_USC_SAR_2020-01-23/HIST2A2B_genes.txt
```{r}
filedf_1_2 <- get_files(
  outputdir = "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/temp/output/serous_newgene/YaleSerous_vs_YaleUCS/"
)
head(filedf_1_2)
diff_table_1_2 <- get_diff_table_unfilter(filedf_1_2)
diff_table_sig_1_2 <- subset(diff_table_1_2, mode == "sig")
datatable(
  diff_table_sig_1_2,
  extensions = 'Buttons',
  options = list(
...
### 3.C.2 Serous_vs_UCS_newGene
Phenotype: a phenotype file for  TCGA UCEC serous, Yale serous, TCGA UCS and Yale UCS. Pull samples from these four categories, if the sample is TCGA UCEC serous or Yale serous, give phenotype value 1, otherwise 0.  
Gene: /dartfs/rc/lab/S/Szhao/diffDriver/diffDriver/data_run_UCS/Yale_USC_SAR_2020-01-23/HIST2A2B_genes.txt
```{r}
filedf_3_2 <- get_files(
  outputdir = "/dartfs/rc/lab/S/Szhao/qiruiz/diffdriver/temp/output/serous_newgene/Serous_vs_UCS/"
)
head(filedf_3_2)
diff_table_3_2 <- get_diff_table_unfilter(filedf_3_2)
diff_table_sig_3_2 <- subset(diff_table_3_2, mode == "sig")
datatable(
  diff_table_sig_3_2,
  extensions = 'Buttons',
  options = list(
...
Gene: /dartfs/rc/lab/S/Szhao/diffDriver/diffDriver/data_run_UCS/Yale_USC_SAR_2020-01-23/HIST2A2B_genes.txt
```{r}
diff_table_reg_1_2 <- subset(diff_table_1_2, mode == "reg")
datatable(
  diff_table_reg_1_2,
  extensions = 'Buttons',
  options = list(
...
Gene: /dartfs/rc/lab/S/Szhao/diffDriver/diffDriver/data_run_UCS/Yale_USC_SAR_2020-01-23/HIST2A2B_genes.txt
```{r}
diff_table_reg_3_2 <- subset(diff_table_3_2, mode == "reg")
datatable(
  diff_table_reg_3_2,
  extensions = 'Buttons',
  options = list(
